...
#add_instance axi_pwm_gen_0 axi_pwm_gen
#set_instance_parameter_value axi_pwm_gen_0 {PULSE_0_PERIOD} {120}
#set_instance_parameter_value axi_pwm_gen_0 {PULSE_0_WIDTH} {1}

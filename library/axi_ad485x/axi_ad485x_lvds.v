...
module axi_ad485x_lvds #(
  ...
  localparam N_CH = OCTA_CHANNEL ? 8 : 4;
  localparam DW  = (32 * N_CH);
  ...
  always @(posedge clk) begin
    ...
    if (start_transfer) begin
      ...
      max_channel_transfer <= adc_crc_enable ? N_CH : N_CH - 1;
